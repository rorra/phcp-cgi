...
int main(int argc, char **argv) {
  ...
  Connection con = new Connection(use_exceptions);
...
int CrearEstadisticas(std::string &idDominio, std::string &dominio) {
  std::string directorio = "/www/docs/webs/phcm/" + dominio + "/stats2/", comando;
  ...
  //Crear las estadisticas
  comando = "/usr/local/bin/http-analyze -U www." + dominio + " -S www." + dominio    
  + " -o /www/docs/webs/phcm/" + dominio + "/stats2/ " + archivo;
...
int ParsearEstadisticas(std::string &dominio, std::string &idDominio) {
  ...
  archivo = "/www/docs/webs/phcm/" + dominio + "/stats2/index.php";
  archivo2 = "/www/docs/webs/phcm/" + dominio + "/stats2/index.php.bak";
